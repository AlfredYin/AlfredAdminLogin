...
using Alfred.CodeGenerator.Model;
using Alfred.Util;
...
namespace Alfred.CodeGenerator.Template
{
    public class SingleTableTemplate
    {
        ...
        public BaseConfigModel GetBaseConfig(string path, string userName, string tableName, string tableDescription, List<string> tableFieldList)
        {
            ...
            baseConfigModel.OutputConfig.OutputEntity = Path.Combine(path, "Alfred.Entity");
            baseConfigModel.OutputConfig.OutputBusiness = Path.Combine(path, "Alfred.Business");
            baseConfigModel.OutputConfig.OutputWeb = Path.Combine(path, "Alfred.Web", "Alfred.Admin.Web");
        ...
        public string BuildEntity(BaseConfigModel baseConfigModel, DataTable dt)
        {
            ...
            sb.AppendLine("using Alfred.Util;");
            sb.AppendLine();

            sb.AppendLine("namespace Alfred.Entity." + baseConfigModel.OutputConfig.OutputModule);
            sb.AppendLine("{");
        ...
        public string BuildEntityParam(BaseConfigModel baseConfigModel)
        {
            ...
            sb.AppendLine("namespace Alfred.Model.Param." + baseConfigModel.OutputConfig.OutputModule);
            sb.AppendLine("{");
        ...
        public string BuildService(BaseConfigModel baseConfigModel, DataTable dt)
        {
            ...
            sb.AppendLine("using Alfred.Util;");
            sb.AppendLine("using Alfred.Util.Extension;");
            sb.AppendLine("using Alfred.Util.Model;");
            sb.AppendLine("using Alfred.Data;");
            sb.AppendLine("using Alfred.Data.Repository;");
            sb.AppendLine("using Alfred.Entity." + baseConfigModel.OutputConfig.OutputModule + ";");
            sb.AppendLine("using Alfred.Model.Param." + baseConfigModel.OutputConfig.OutputModule + ";");

            sb.AppendLine();

            sb.AppendLine("namespace Alfred.Service." + baseConfigModel.OutputConfig.OutputModule);
            sb.AppendLine("{");
        ...
        public string BuildBusiness(BaseConfigModel baseConfigModel)
        {
            ...
            sb.AppendLine("using Alfred.Entity." + baseConfigModel.OutputConfig.OutputModule + ";");
            sb.AppendLine("using Alfred.Model.Param." + baseConfigModel.OutputConfig.OutputModule + ";");
            sb.AppendLine("using Alfred.Service." + baseConfigModel.OutputConfig.OutputModule + ";");
            sb.AppendLine();

            sb.AppendLine("namespace Alfred.Business." + baseConfigModel.OutputConfig.OutputModule);
            sb.AppendLine("{");
        ...
        public string BuildController(BaseConfigModel baseConfigModel)
        {
            ...
            sb.AppendLine("using Alfred.Util;");
            sb.AppendLine("using Alfred.Util.Model;");
            sb.AppendLine("using Alfred.Entity;");
            sb.AppendLine("using Alfred.Model;");
            sb.AppendLine("using Alfred.Admin.Web.Controllers;");
            sb.AppendLine("using Alfred.Entity." + baseConfigModel.OutputConfig.OutputModule + ";");
            sb.AppendLine("using Alfred.Business." + baseConfigModel.OutputConfig.OutputModule + ";");
            sb.AppendLine("using Alfred.Model.Param." + baseConfigModel.OutputConfig.OutputModule + ";");
            sb.AppendLine();

            sb.AppendLine("namespace Alfred.Admin.Web.Areas." + baseConfigModel.OutputConfig.OutputModule + ".Controllers");
            sb.AppendLine("{");
        ...
        public async Task<List<KeyValue>> CreateCode(BaseConfigModel baseConfigModel, string code)
        {
            ...
            if (!string.IsNullOrEmpty(param["CodeEntity"].ParseToString()))
            {
                ...
                string codePath = Path.Combine(baseConfigModel.OutputConfig.OutputEntity, "Alfred.Entity", baseConfigModel.OutputConfig.OutputModule, baseConfigModel.FileConfig.EntityName + ".cs");
            ...
            if (!param["CodeEntityParam"].IsEmpty())
            {
                ...
                string codePath = Path.Combine(baseConfigModel.OutputConfig.OutputEntity, "Alfred.Model", "Param", baseConfigModel.OutputConfig.OutputModule, baseConfigModel.FileConfig.EntityParamName + ".cs");
                if (!File.Exists(codePath))
                {
            ...
            if (!param["CodeService"].IsEmpty())
            {
                ...
                string codePath = Path.Combine(baseConfigModel.OutputConfig.OutputBusiness, "Alfred.Service", baseConfigModel.OutputConfig.OutputModule, baseConfigModel.FileConfig.ServiceName + ".cs");
                if (!File.Exists(codePath))
                {
            ...
            if (!param["CodeBusiness"].IsEmpty())
            {
                ...
                string codePath = Path.Combine(baseConfigModel.OutputConfig.OutputBusiness, "Alfred.Business", baseConfigModel.OutputConfig.OutputModule, baseConfigModel.FileConfig.BusinessName + ".cs");
                if (!File.Exists(codePath))
                {
